...
if __name__ == '__main__' :
    ...
    text_data = dir_path + "/files/NLP_data.json"
    images_data = dir_path + "/files/small_data.json"
    ...
    for image_name in tqdm(images_data.keys()):
        ...
        txt_path = dir_path + "/results/results_topic_" + text_data["topic"] + ".txt"
        f = open(txt_path,"a+")
        ...
        ''''
        print("positive score: " , total_positive_score)
        print("total score: ", total_score)
        print("categories analysed : ", 5-empty)
        print("")
        '''
