...
Figure \ref{fig:app_diagram} illustrates the different stages presented in the interactive system and Figure \ref{fig:app_view} shows a screenshot of the application retrieval view.
...
\begin{figure}[H]
  ...
  \includegraphics[width=\textwidth]{Sections/7Results/images/Appdiagram.png} 
