...
\label{sec:process_dataset}
    ...
    In order to extract the maximum possible labels, all images in the imageclef dataset were fully processed with YOLOv3 and the Places scene recognition model. This is an exhaustive approach since it takes a lot of computer processing time and resources. 
